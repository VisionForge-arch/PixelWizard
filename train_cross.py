...
import wandb
from model_wan_trainer_cross import WanModel_Trainer
...
def main():
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_2k_cross_wo_rope")

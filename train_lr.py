...
def main():
    ...
    parser.add_argument("--config_path", type=str, default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Code/ultrawan/configs/self_forcing_dmd_lr.yaml")
    parser.add_argument("--logdir", type=str, default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_240p_new")
    parser.add_argument("--generator_ckpt", type=str, default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_240p/checkpoint_model_000100/model.pt")
    ...
    default_config = OmegaConf.load("/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Code/ultrawan/configs/default_config.yaml")

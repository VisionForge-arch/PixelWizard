...
parser.add_argument("--data_path", type=str, default="/hpc2hdd/home/htian395/Wenxue/Self-Forcing/prompts/MovieGenVideoBench_extended.txt", help="Path to the dataset")

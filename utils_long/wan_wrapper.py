...
from wan_long.modules.tokenizers import HuggingfaceTokenizer
from wan_long.modules.model import WanModel, RegisterTokens, GanAttentionBlock
from wan_long.modules.vae import _video_vae
from wan_long.modules.t5 import umt5_xxl
from wan_long.modules.causal_model import CausalWanModel
...
class WanTextEncoder(torch.nn.Module):
    def __init__(self) -> None:
        ...
        self.text_encoder.load_state_dict(
            torch.load("/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.1-T2V-1.3B/models_t5_umt5-xxl-enc-bf16.pth",
                       map_location='cpu', weights_only=False)
        )

        self.tokenizer = HuggingfaceTokenizer(
            name="/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.1-T2V-1.3B/google/umt5-xxl/", seq_len=512, clean='whitespace')
...
class WanVAEWrapper(torch.nn.Module):
    def __init__(self):
        ...
        self.model = _video_vae(
            pretrained_path="/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth",
            z_dim=16,
        ).eval().requires_grad_(False)
...
class WanDiffusionWrapper(torch.nn.Module):
    def __init__(
        ...
        self.model = WanModel.from_pretrained(f"/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.1-T2V-1.3B/")
        self.model.eval()

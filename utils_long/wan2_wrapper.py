...
class WanTextEncoder(torch.nn.Module):
    def __init__(self) -> None:
        ...
        self.text_encoder.load_state_dict(
            torch.load("/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.2-TI2V-5B/models_t5_umt5-xxl-enc-bf16.pth",
                       map_location='cpu', weights_only=False)
        )

        self.tokenizer = HuggingfaceTokenizer(
            name="/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.2-TI2V-5B/google/umt5-xxl/", seq_len=512, clean='whitespace')
...
class WanVAEWrapper2_2(torch.nn.Module):
    def __init__(self):
        super().__init__()
        mean = [
        ...
        std = [
                0.4765, 1.0364, 0.4514, 1.1677, 0.5313, 0.4990, 0.4818, 0.5013, 0.8158, 1.0344,
        ...
        self.model = _video_vae(
            pretrained_path="/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.2-TI2V-5B/Wan2.2_VAE.pth",
            z_dim=48,
...
class WanDiffusionWrapper(torch.nn.Module):
    def __init__(
        ...
        self.model = WanModel.from_pretrained(f"/hpc2ssd/JH_DATA/spooler/htian395/Wenxue/Weight/Wan2.2-TI2V-5B")
        self.model.eval()

...
class WanTextEncoder(torch.nn.Module):
    def __init__(self) -> None:
        ...
        self.text_encoder.load_state_dict(
            torch.load("/mnt/nas01-ak/PretrainedModels/videogen_models/Wan2.2-TI2V-5B/models_t5_umt5-xxl-enc-bf16.pth",
                       map_location='cpu', weights_only=False)
        )

        self.tokenizer = HuggingfaceTokenizer(
            name="/mnt/nas01-ak/PretrainedModels/videogen_models/Wan2.2-TI2V-5B/google/umt5-xxl/", seq_len=512, clean='whitespace')
...
class WanVAEWrapper2_2(torch.nn.Module):
    def __init__(self):
        ...
        self.model = _video_vae(
            pretrained_path="/mnt/nas01-ak/PretrainedModels/videogen_models/Wan2.2-TI2V-5B/Wan2.2_VAE.pth",
            z_dim=48,
...
class WanDiffusionWrapper(torch.nn.Module):
    def __init__(
        ...
        self.model = WanModel.from_pretrained(f"/mnt/nas01-ak/PretrainedModels/videogen_models/Wan2.2-TI2V-5B")
        self.model.eval()

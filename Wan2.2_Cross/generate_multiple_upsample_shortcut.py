...
def _parse_args():
    ...
    parser.add_argument(
        "--size",
        type=str,
        default="2560*1440",  # 3840*2144, 2560*1440
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/240p_upsample_2k_shortcut/pt",
    ...
    parser.add_argument(
        ...
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/2k_shortcut/checkpoint_model_000800/model.pt",
...
def generate(args):
    ...
    wan_ti2v = wan.WanTI2V_Upsample_Shortcut(
        config=cfg,

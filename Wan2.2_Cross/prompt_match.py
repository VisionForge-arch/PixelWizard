...
# === 配置路径 ===
prompt_txt = "/root/ultrawan/Wan2.2/prompt4.txt"                   # 每行一个 prompt
video_dir  = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/240p_niren/pt_1"        # 存放 .mp4 或 .pt 文件的目录
...
out_json = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/prompts/niren_240p_pt.json"

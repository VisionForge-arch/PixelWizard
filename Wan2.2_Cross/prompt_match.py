...
# === 配置路径 ===
prompt_txt = "/root/ultrawan/Wan2.2/prompt_env.txt"                   # 每行一个 prompt
video_dir  = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/240p_env/pt_20"        # 存放 .mp4 或 .pt 文件的目录


pat = re.compile(r"^ti2v-5B_256\*448_8_(?:\+?prompt_)?(?P<frag>.+?)_\d{8}_\d{6}\.(?:pt|mp4)$")
...
out_json = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/prompts/env_240p_pt_20.json"

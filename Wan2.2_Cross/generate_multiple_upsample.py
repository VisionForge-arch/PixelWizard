...
def _parse_args():
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/480p_upsample_1",
    ...
    parser.add_argument(
        ...
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_latent_up/checkpoint_model_002600/model.pt",
    ...
    for prompt_idx, data in enumerate(dataloader):
        ...
        for resolution in resolutions:
            ...
            with torch.no_grad():
                ...
                cond_latent_lr = cond_latent_lr.reshape(B*C, T, h, w)  # [B*T, C, h, w]

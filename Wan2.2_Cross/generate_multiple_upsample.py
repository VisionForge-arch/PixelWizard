...
def _parse_args():
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/480p_upsample_2",
    ...
    parser.add_argument(
        ...
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/480p_i2v_matched.json",
        help="The file to read the prompts from.")
    parser.add_argument(
        "--wan_ckpt",
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_latent_up/checkpoint_model_002300/model.pt",

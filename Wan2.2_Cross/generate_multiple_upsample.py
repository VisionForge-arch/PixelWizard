...
def _parse_args():
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/480p_base/720p_upsample_first10",
    ...
    parser.add_argument(
        ...
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_latent_up_2/checkpoint_model_002300/model.pt",

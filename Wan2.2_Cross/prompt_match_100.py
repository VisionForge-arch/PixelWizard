...
# === 配置路径 ===
prompt_txt = "/root/ultrawan/extracted_texts"                   # 每行一个 prompt
video_dir  = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/eval_100/240p_5s/pt_new"        # 存放 .mp4 或 .pt 文件的目录
...
out_json = "/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/prompts/eval_100_match_240_new.json"

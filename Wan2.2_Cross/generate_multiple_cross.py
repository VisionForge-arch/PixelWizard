...
def _parse_args():
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/2k_cross/2k_train_700",
    ...
    parser.add_argument(
        ...
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_2k_cross/checkpoint_model_000300/model.pt",

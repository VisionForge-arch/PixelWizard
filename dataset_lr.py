...
class ToAbsolutePath(DataProcessingOperator):
    ...
    def __call__(self, data):
        # Keep absolute paths intact; otherwise join with base_path when provided.
        if data is None or os.path.isabs(data) or self.base_path in ("", None):
            return data
...
class UnifiedDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        elif isinstance(data_file_keys, list):

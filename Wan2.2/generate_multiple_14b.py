...
def _parse_args():
    ...
    parser.add_argument(
        "--ckpt_dir",
        type=str,
        default="/mnt/vision-gen-ks3/ModelZoo/Video_Generation/Wan2.2-T2V-A14B",
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/outputs_ultra/14b_infer/480p",

...
def _parse_args():
    ...
    parser.add_argument(
        "--sample_steps", type=int, default=12, help="The sampling steps.")
    parser.add_argument(
        "--sample_shift",
        type=float,
        default=None,
    ...
    parser.add_argument(
        ...
        type=str,
        #default=None,
        default="/mnt/vision-gen-ks3/IndividualDirs/zp/wenxueli/Output/Ultra_Train_Weight/wan_latent_up/checkpoint_model_000800/model.pt",
